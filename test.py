...
def test(cfg,
    ...
    if model is None:
        ...
        # Remove previous
        for f in glob.glob('./test_png/test_batch*.png'):
            os.remove(f)
    ...
    for batch_i, (imgs, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        f = './test_png/test_batch%g.png' % batch_i  # filename
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3_spp.cfg', help='*.cfg path')
