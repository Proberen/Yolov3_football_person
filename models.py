    ...
    for i, mdef in enumerate(module_defs):
        ...
        if mdef['type'] == 'convolutional':
            ...
            if bn:
                ...
                routs.append(i)  # detection output1 (goes into yolo layer)
        ...
        # Register module list and number of output1 filters
...
class YOLOLayer(nn.Module):
    def __init__(self, anchors, nc, img_size, yolo_index, layers):
        ...
        self.layers = layers  # model output1 layer indices
        self.nl = len(layers)  # number of output1 layers (3)
...
class Darknet(nn.Module):
    ...
    def forward(self, x, verbose=False):
        ...
        if self.training:  # train
            ...
            io, p = zip(*yolo_out)  # inference output1, training output1
